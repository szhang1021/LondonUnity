...
namespace Google.Maps.Examples {
  ...
  public class Vehicle : MonoBehaviour {
    ...
    /// <summary>
    /// The location of the last node this vehicle visited.
    /// </summary>
    private ulong CurrentNodeLocation;

    /// <summary>
    /// The location of the target node for this vehicle to path to.
    /// </summary>
    private ulong TargetNodeLocation;
    ...
    public void Initialize(TrafficSystem trafficSystem, RoadLatticeNode startNode) {
      ...
      CurrentNodeLocation = startNode.LocationUID;
      TargetNodeLocation = targetNode.LocationUID;
    ...
    void Update() {
      ...
      RoadLatticeNode currentNode = TrafficSystem.RoadLattice.FindNodeAt(CurrentNodeLocation);
      RoadLatticeNode targetNode = TrafficSystem.RoadLattice.FindNodeAt(TargetNodeLocation);
      ...
      if (Ticket == null) {
        ...
        Ticket = TrafficSystem.Request(CurrentNodeLocation, TargetNodeLocation, this);
        if (Ticket == null) {
      ...
      if (Ticket.DistanceToTarget < MaxDistanceUntilNextTarget) {
        ...
        TrafficSystem.PathTicket nextTicket =
            TrafficSystem.Request(TargetNodeLocation, nextTargetNode.LocationUID, this);
        if (nextTicket == null) {
        ...
        Ticket.Release();
        Ticket = nextTicket;
        CurrentNodeLocation = TargetNodeLocation;
        TargetNodeLocation = nextTargetNode.LocationUID;
      }
    }
